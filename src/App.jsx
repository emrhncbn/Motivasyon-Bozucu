    ...
    <div className='wrapper'>
      {currentData && (
        <div className='quote-container' style={currentData.image.wrapperStyles}>
          <div className='image-container' style={currentData.image.containerStyles}>
            <img src={currentData.image.src} alt={currentData.image.alt} />
          </div>
          <div className='quote-content'>
            <p className='quote' style={getSmallestFontSize(currentData.text.quoteFontSize, currentData.image.quoteFontSize)}>
